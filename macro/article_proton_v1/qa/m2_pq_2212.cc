...
void m2_pq_2212(){
  ...
  plot.AddSubPlot( std::vector<double>{ 0.0, 0.0, 0.5, 1.0 } )
    ...
    .AddToPlot( "/home/mikhail/ris2/macro/article_proton_v1/files/qa.2026.03.18.root", "h2_pq_mass2_tof400_2212" )
    ;
  plot.AddSubPlot( std::vector<double>{ 0.5, 0.0, 1.0, 1.0 } )
    ...
    .SetYAxis(Axis().SetTitle("m^{2} (GeV^{2}/c^{4})").SetLo(-0.5).SetHi(9.5))
    .SetZAxis(Axis().SetTitle("v_{1}").SetLog())
    .AddToPlot( "/home/mikhail/ris2/macro/article_proton_v1/files/qa.2026.03.18.root", "h2_pq_mass2_tof700_2212" )
    ;
  plot.Print( "/home/mikhail/ris2/macro/article_proton_v1/pic/m2_pq_2212.png" );
};